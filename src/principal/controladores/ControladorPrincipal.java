...
//        System.out.println();
    ...
    */
        ...
        if (!listapdp1.contains(pdp2))
            listapdp1.add(pdp2);
        Pedido unPedido1 = new Pedido(1, LocalDateTime.now(),Estados.CREADO, listapdp1, (Cliente)usuarios.get(0));        
        ...
        if (!productosDelPedido2.contains(pdp5))
            productosDelPedido2.add(pdp5);
        Pedido unPedido2 = new Pedido(2, LocalDateTime.now(),Estados.CREADO, productosDelPedido2, (Cliente)usuarios.get(1));        
        ...
        if (!productosDelPedido3.contains(pdp7))
            productosDelPedido3.add(pdp7);
        Pedido unPedido3 = new Pedido(2, LocalDateTime.now(),Estados.ENTREGADO, productosDelPedido3, (Cliente)usuarios.get(2));        
        //pedido repetido
